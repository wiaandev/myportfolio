...
function back_wpb_load_widget() {
    register_widget( 'backframework_recent_widget' );
}
add_action( 'widgets_init', 'back_wpb_load_widget' );
 
// Creating the widget 
class backframework_recent_widget extends WP_Widget {
...
__('Back Core Recent Post Widget', 'backframework'), 
 
// Widget description
array( 'description' => __( 'Recent post widget with different options', 'backframework' ), ) 
);
}
...
if ( ! isset( $args['widget_id'] ) ) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Recent Posts','backframework' );
                ...
                <div class="show-featured clearfix">
                    <div class="post-img"> 
                        <a href="<?php the_permalink(); ?>">
                            <?php the_post_thumbnail('enthor_footer-post'); ?>
                        </a> 
                    </div>
                    <div class="post-item">
                        <div class="post-desc"> 
...
<p>
  <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>">
    <?php esc_html_e( 'Title:','backframework' ); ?>
  </label>
...
<p>
  <label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>">
    <?php esc_html_e( 'Number of posts to show:','backframework' ); ?>
  </label>
...
<p>
  ...
  <label for="<?php echo esc_attr($this->get_field_id( 'show_date' )); ?>">
    <?php esc_html_e( 'Display post date?','backframework' ); ?>
  </label>
</p>
<p>
  ...
  <label for="<?php echo esc_attr($this->get_field_id( 'show_featured_image' )); ?>">
    <?php esc_html_e( 'Display featured image?','backframework' ); ?>
  </label>
</p>
<?php
	}
