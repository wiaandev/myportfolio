...
class back_Elementor_pro_bkCounter_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Back Counter', 'back' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label'   => esc_html__( 'Select Counter Style', 'back' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'style1',
				'options' => [					
					'style1' => esc_html__( 'Style 1', 'back'),
					'style2' => esc_html__( 'Style 2', 'back'),
					'style3' => esc_html__( 'Style 3', 'back'),
		...
		$this->add_control(
			'number',
			[
				'label' => esc_html__( 'Counter Number', 'back' ),
		...
		$this->add_control(
			'suffix',
			[
				'label' => esc_html__( 'Number Prefix', 'back' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'placeholder' => esc_html__( 'Prefix', 'back' ),
				'separator' => 'before',
			]
		...
		$this->add_control(
			'prefix',
			[
				'label' => esc_html__( 'Number Suffix', 'back' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'placeholder' => 'Suffix',
				'separator' => 'before',
		...
		$this->add_control(
			'title',
			[
				'label' => esc_html__( 'Counter Title', 'back' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__( 'Happy Clients', 'back' ),
				'placeholder' => esc_html__( 'Clients', 'back' ),
				'separator' => 'before',
			]
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[	'label' => esc_html__( 'Sufix Typography', 'back' ),
		...
		$this->add_control(
			'prefix_color',
			[
				'label' => esc_html__( 'Sufix Color', 'back' ),
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			[	'label' => esc_html__( 'Prefix Typography', 'back' ),
		...
		$this->add_control(
			'stroke_color_yes_no',
			[
				'label'   => esc_html__( 'Stroke Color Enable/Disable', 'back' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'disable',
				'options' => [					
					'enable' => esc_html__( 'Enable', 'back'),
					'disable' => esc_html__( 'Disable', 'back'),
				],
			]
		);
        ...
        $this->add_control(
			'stroke_number_color',
			[
				'label' => esc_html__( 'Stroke Inside Color', 'back' ),
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'Stroke Outside Color', 'back' ),
				'type' => Controls_Manager::COLOR,				
				'selectors' => [
		...
		$this->add_responsive_control(
		    'icon_width',
		    [
		        'label' => esc_html__( 'Icon/Image Part Width', 'back' ),
		...
		$this->add_responsive_control(
		    'icon_height',
		    [
		        'label' => esc_html__( 'Icon/Image Part Height', 'back' ),
		        'type' => Controls_Manager::SLIDER,
		        'size_units' => [ 'px' ],
		        'range' => [
		            'px' => [
		...
		$this->add_responsive_control(
		    'icon_line_height',
		    [
		        'label' => esc_html__( 'Icon/Image Part Line Height', 'back' ),
		        'type' => Controls_Manager::SLIDER,
		        'size_units' => [ 'px', '%' ],
		        'range' => [
		            'px' => [
		...
		$this->add_responsive_control(
		    'image_width',
		    [
		        'label' => esc_html__( 'Image Width', 'back' ),
		        'type' => Controls_Manager::SLIDER,
		        'size_units' => [ 'px', '%' ],
		        'range' => [
		            'px' => [
		...
		$this->add_responsive_control(
		    'icon_padding',
		    [
		        'label' => esc_html__( 'Icon Part Padding', 'back' ),
		        'type' => Controls_Manager::DIMENSIONS,
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		...
		$this->add_responsive_control(
		    'icon_margin',
		    [
		        'label' => esc_html__( 'Icon Part Margin', 'back' ),
		        'type' => Controls_Manager::DIMENSIONS,
		        'size_units' => [ 'px', 'em', '%' ],
		        'selectors' => [
		...
		$this->start_controls_tabs( 'back_part_btn_tabs' );
			...
			$this->start_controls_tab(
				...
				$this->add_control(
					'icon_hover_color',
					[
						'label' => esc_html__( 'Icon Hover Color', 'back' ),
						'type' => Controls_Manager::COLOR,				
						'selectors' => [
	...
	protected function render() {
        ...
        $this->add_render_attribute( 'number', 'class', 'back-counter' );
		    ...
		    <div class="back-counter-list">
			    ...
			    <div class="count-text">
			    	...
			    	<?php if(!empty($settings['title'])) : ?>
			    		<span <?php echo wp_kses_post($this->print_render_attribute_string('title'));?>>  <?php echo wp_kses_post($settings['title']);?></span>	
			    	<?php endif; ?>	
