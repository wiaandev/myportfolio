...
<?php if($banner_hide !='hide'){
    ...
    if(!empty($enthor_option['disable_portfoli_banner'])): ?>
    ...
    <?php }
    elseif (!empty($enthor_option['department_single_image']['url'])) {
        ?>
        <div class="breadcrumbs-single" style="background-image: url('<?php echo esc_url( $enthor_option['department_single_image']['url'] );?>')">
            <div class="<?php echo esc_attr($header_width);?>">
              <div class="row">
                <div class="col-md-12 text-center">
                  <div class="breadcrumbs-inner bread-<?php echo esc_attr($post_menu_type); ?>"> 
