...
if(!empty($enthor_option['show_preloader']))
  {
    $loading = $enthor_option['show_preloader'];
    if(!empty($enthor_option['preloader_img'])){
      $preloader_img = $enthor_option['preloader_img'];
    }
    if($loading == 1){
